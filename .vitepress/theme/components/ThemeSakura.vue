<!-- 改自 vuepress-plugin-sakura: https://github.com/JabinPeng/vuepress-plugin-sakura -->
<template>
  <div class="Sakura">
    <canvas id="canvas_sakura" ref="canvas_sakura" :style="{ zIndex }"></canvas>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    startSakura() {
      ...
      const img = new Image()
      img.src =
        'https://raw.githubusercontent.com/JabinPeng/vuepress-plugin-sakura/master/bin/sakura.png' //樱花效果图路径
